...
const NUMBERS = [
    ...
    { n: 40,   medumba: 'ŋamnkuὰ',               frEn: ['Quarante',  'Forty']       },
    { n: 50,   medumba: 'ŋamntὰn',               frEn: ['Cinquante', 'Fifty']       },
    { n: 60,   medumba: 'ŋamntogə',              frEn: ['Soixante',  'Sixty']       },
    { n: 70,   medumba: 'ŋamnsὰmbα̂',            frEn: ['Soixante-dix','Seventy']   },
    { n: 80,   medumba: 'ŋamnfomə',              frEn: ['Quatre-vingts','Eighty']   },
    { n: 90,   medumba: "ŋamnbwə̀'ə",            frEn: ['Quatre-vingt-dix','Ninety']},
