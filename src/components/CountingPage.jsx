...
const NUMBERS = [
    ...
    { n: 60,   medumba: 'ntogə gham',            frEn: ['Soixante',  'Sixty']       },
    { n: 70,   medumba: 'sὰmbα̂ gham',           frEn: ['Soixante-dix','Seventy']   },
    { n: 80,   medumba: 'fomə gham',             frEn: ['Quatre-vingts','Eighty']   },
    { n: 90,   medumba: "bwə̀'ə gham",           frEn: ['Quatre-vingt-dix','Ninety']},
